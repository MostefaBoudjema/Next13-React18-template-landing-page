...
function Header() {
    ...
    function NavLink({ to, children }) {
        ...
        const activeClass = isActive ? 'text-blue-200' : 'text-purple-600';

        return (
            <li>
                <Link
                    to={to}
                    className={`font-medium ${activeClass} hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out`}
                >
                    {children}
                </Link>
            </li>
