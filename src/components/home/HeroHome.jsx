      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4" data-aos="fade-up">{infos.hero_title}</h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">{infos.hero_desc}</p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div data-aos="fade-up" data-aos-delay="400">
                <a className="btn text-white bg-purple-600 hover:bg-purple-700 w-full mb-4 sm:w-auto sm:mb-0" href="#0">{infos.hero_btn_left}</a>
              </div>
              <div data-aos="fade-up" data-aos-delay="600">
                <a className="btn text-white bg-gray-700 hover:bg-gray-800 w-full sm:w-auto sm:ml-4" href="#0">{infos.hero_btn_right}</a>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="relative flex justify-center items-center" data-aos="fade-up" data-aos-delay="200">
              <img className="mx-auto" src={infos.hero_img} width="1024" height="504" alt="Hero" />
